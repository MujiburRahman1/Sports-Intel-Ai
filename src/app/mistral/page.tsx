    ...
    <div className="min-h-screen bg-slate-900 relative overflow-hidden">
      ...
      <nav className="border-b border-slate-700/50 bg-slate-900/95 backdrop-blur-sm sticky top-0 z-50">
        ...
        <div className="hidden md:flex items-center gap-8 text-gray-300">
          ...
          <Link href="/mistral" className="text-cyan-400 font-medium">🧠 Mistral AI</Link>
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden border-t border-slate-700/50 bg-slate-900/95">
          <div className="container py-4 flex flex-col gap-4">
            ...
            <Link href="/mistral" onClick={() => setIsMobileMenuOpen(false)} className="text-cyan-400 font-medium">🧠 Mistral AI</Link>
